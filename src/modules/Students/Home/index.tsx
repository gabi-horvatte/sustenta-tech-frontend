...
export const StudentHome = () => {
  return (
    <div id="student-home" className="flex flex-col bg-lime-700/50 min-h-full">
      ...
      <div className="pt-6 pb-6 flex-grow">
        <div className="mx-auto max-w-[50vw] flex flex-col gap-4">
          <TopicsRow />
        </div>
      </div>
    </div>
